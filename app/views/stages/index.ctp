						...
						<?php
							foreach ($docoffre as $d):
								...
								echo(    '<tr>
									...
									<td>'.$this->Html->link('Visualiser', array('controller' => 'files', 'action' => 'stages-offres', $nom), array('class' => 'btn small info')) .'</td>
									</tr>');
							endforeach;
						?>
					</tbody>
				...
				<tbody>
					<?php
						foreach ($docutile as $d):
							...
							echo(    '<tr>
						        		<td>'.$d['DocumentsStage']['nom'].'</td>
								<td>'.$this->Html->link('Visualiser', array('controller' => 'files', 'action' => 'stages-utiles', $nom), array('class' => 'btn small info')) .'</td>
								</tr>');
						endforeach;
					?>
				</tbody>
