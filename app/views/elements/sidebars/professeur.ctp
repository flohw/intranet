<div class="sidebar">
	...
	<h3 class="active">Raccourcis</h3>
		<div>
			<ul>
		    		<li><?php echo $this->Html->link('Emploi du temps', array('controller' => 'timetable', 'action' => 'index')); ?></li>
		    		...
		    		<li><?php echo $this->Html->link('Les absences', array('controller' => 'absences', 'action' => 'ajouter')); ?></li>	
		    		<li><?php echo $this->Html->link('Mes documents', array('controller' => 'documents', 'action' => 'vue')); ?></li>	
		    	</ul>
	    	</div>
